...
<!-- Menu -->
 <section>
                     ...
                     <?php foreach ($pengajuansppt as $row): ?>
                                    <tr>
                                        ...
                                        <td>
                                                   <span>Selesai</span>
                                    <div class="switch">
                                    <label><input type="checkbox"><span class="lever" checked in checked></span></label>
                                         </div>                     
                                     </td>
                                    </tr>
                                    <?php endforeach; ?>
        ...
        <div class="modal fade" id="modal_add_new" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url().'admin/datapengajuansppt/add'?>">
